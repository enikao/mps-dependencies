...
<model modelUID="r:fefd51b4-1ab3-41f0-96eb-21e5290850f5(LangNewTypesystem.typesystem)">
      ...
      <node role="statement" roleId="tpee.1068581517665" type="tpd4.CreateEquationStatement" typeId="tpd4.1174658326157" id="7828359547244644542" nodeInfo="nn">
        <node role="rightExpression" roleId="tpd4.1174660783414" type="tpd4.NormalTypeClause" typeId="tpd4.1185788614172" id="7828359547244644565" nodeInfo="ng">
          <node role="normalType" roleId="tpd4.1185788644032" type="tpd4.TypeOfExpression" typeId="tpd4.1174657487114" id="7828359547244644561" nodeInfo="nn">
            <node role="term" roleId="tpd4.1174657509053" type="tpee.DotExpression" typeId="tpee.1197027756228" id="7828359547244686268" nodeInfo="nn">
              <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="7828359547244644696" nodeInfo="nn">
                ...
                <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkListAccess" typeId="tp25.1138056282393" id="7828359547244682772" nodeInfo="nn">
                  <link role="link" roleId="tp25.1138056546658" targetNodeId="drz0.7828359547244626743" />
                </node>
              </node>
              <node role="operation" roleId="tpee.1197027833540" type="tp2q.GetLastOperation" typeId="tp2q.1165595910856" id="7828359547244693135" nodeInfo="nn" />
            </node>
          </node>
        </node>
