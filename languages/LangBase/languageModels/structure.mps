...
<model modelUID="r:09d89437-e547-4fc8-960d-6295320c7ab6(LangBase.structure)">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="7828359547244626487" nodeInfo="ig">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="7828359547245313224" nodeInfo="ig">
      <property name="metaClass" nameId="tpce.1071599937831" value="aggregation" />
      <property name="role" nameId="tpce.1071599776563" value="ifaceContent" />
      <link role="target" roleId="tpce.1071599976176" targetNodeId="7828359547244626539" resolveInfo="LangBaseIface" />
    </node>
  </root>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="7828359547244626740" nodeInfo="ig">
    ...
    <property name="conceptAlias" nameId="tpce.5092175715804935370" value="base" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="7828359547245446079" nodeInfo="ig">
    <property name="name" nameId="tpck.1169194664001" value="LangBaseIfaceImpl" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="7828359547245446131" nodeInfo="ig">
      <link role="intfc" roleId="tpce.1169127628841" targetNodeId="7828359547244626539" resolveInfo="LangBaseIface" />
    </node>
  </root>
</model>
